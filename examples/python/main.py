"""
Example: How to call the url-to-pdf-converter actor using Apify API Client

For full documentation of the Apify Client for Python, see: https://docs.apify.com/api/client/python
For full documentation of the actor, see: https://apify.com/lexis-solutions/url-to-pdf-converter
...
def run_actor():
    """Run the url-to-pdf-converter actor and retrieve results."""
    ...
    actor_id = "lexis-solutions/url-to-pdf-converter"
